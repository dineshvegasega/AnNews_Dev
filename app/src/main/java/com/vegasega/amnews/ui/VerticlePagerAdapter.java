...
public class VerticlePagerAdapter extends PagerAdapter {
    ...
    public VerticlePagerAdapter(Context context, ArrayList<Item> list, TextToSpeech textToSpeechVoice ) {
        mContext = context;
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        View itemView = mLayoutInflater.inflate(R.layout.card_item_view, container, false);
